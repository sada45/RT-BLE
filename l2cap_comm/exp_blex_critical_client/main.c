...
//
			...
			gap_conn_params.itvl_max = conn.conn_itvl;
			gap_conn_params.itvl_min = conn.conn_itvl;
//			gap_conn_params.offset = 4 * i;
	...
	kernel_pid_t conn_upd_pid = thread_create(conn_upd_thread_buf, sizeof(conn_upd_thread_buf), THREAD_PRIORITY_MAIN-1,
								THREAD_CREATE_STACKTEST, conn_upd_thread_func, NULL, "periodic report");
	conn_upd_thread = thread_get(conn_upd_pid);
	char line_buf[512];
